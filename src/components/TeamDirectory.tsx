...
import { Search, Plus, Filter, Mail, MapPin, MoreVertical, Phone } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-space-gray">Organization</h1>
          <p className="text-gray-500 mt-1">Manage all employees and their information in one place.</p>
        </div>
